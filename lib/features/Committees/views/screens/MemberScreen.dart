...
import '../../../employees/view/screens/EmployeesTabContent.dart';
...
class _MembersPageState extends State<MembersPage> {
  ...
  void initState() {
    super.initState();
    context.read<CommitteesCubit>().getCommitteeMembers(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              widget.cubit.getCommittees(CacheHelper.getData("companyId"));
            },
          ),
        ],
      ),
          ...
          children: [
            ...
            Expanded(
              ...
              builder: (context, state) {
                  ...
                  if (state is GetCommitteeMembersError) {
                    return Center(
                      child: Text(
                        "حدث خطأ: ${state.error}",
                  ...
                  if (state is GetCommitteeMembersSuccess) {
